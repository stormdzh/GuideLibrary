...
//                            canvas.drawBitmap(tipBitmaps.get(i), left + vWidth / 2, jtTop + jtUpLeft.getHeight(), null);
                            canvas.drawBitmap(tipBitmaps.get(i), left + vWidth / 2, jtTop, null);
                        }
                    } else {
...
//                            canvas.drawBitmap(tipBitmaps.get(i), left + vWidth / 2 - 100 - tipBitmaps.get(i).getWidth() / 2, jtTop + jtUpRight.getHeight(), null);
                            canvas.drawBitmap(tipBitmaps.get(i), left + vWidth / 2 - 100 - tipBitmaps.get(i).getWidth() / 2, jtTop, null);
                        }
                    }
                } else {
//                    int jtTop = highLightStyle == VIEWSTYLE_CIRCLE ? top - jtDownLeft.getHeight()-radius/3 -highLisghtPadding- margin : top - jtDownLeft.getHeight() - margin-highLisghtPadding;
                    int jtTop = highLightStyle == VIEWSTYLE_CIRCLE ? top - radius / 3 - highLisghtPadding - margin : top - margin - highLisghtPadding;
        ...
        // 在底部绘制知识了按钮
        canvas.drawBitmap(myKnowBtn, (screenW - myKnowBtn.getWidth()) / 2, (screenH - UiUtil.dip2px(getContext(), 100) - myKnowBtn.getHeight()), null);
    }
